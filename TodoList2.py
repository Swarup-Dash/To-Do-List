...
if __name__ == "__main__":
    ...
    task_label = Label(function_frame, text="TO-DO-LIST \n Enter the task title:", font=("arial", "14", "bold"),
                       background="#00FFFF", foreground="#1E1E1E")
    ...
    add_button = Button(function_frame, text="Add", width=15, bg='#00CD66', font=("arial", "14", "bold"), command=add_task)
    del_button = Button(function_frame, text="Remove", width=15, bg='#00CD66', font=("arial", "14", "bold"), command=delete_task)
    del_all_button = Button(function_frame, text="Delete All", width=15, bg='#00CD66', font=("arial", "14", "bold"),command=delete_all_task)
    exit_button = Button(function_frame, text="Exit", width=15, bg='#00CD66', font=("arial", "14", "bold"), command=close)
    ...
    task_listbox = Listbox(function_frame, width=70, height=9, font="bold", selectmode="SINGLE", background="#B9D3EE",
